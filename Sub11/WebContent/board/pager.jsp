...
//					  									  [6],[7],[8],[9],[10]
	...
	// 마지막 행 번호가 전체 행 번호보다 크면, 마지막 행 번호를 전체 행번호 값으로 보정
...
// 	현재 페이지(정수) / 한페이지 당 보여줄 페이지 번호 수(정수) + (그룹 번호는 현제 페이지(정수) % 한페이지 당 보여줄 페이지 번호 수(정수)>0 ? 1 : 0)
...
한 페이지 당 레코드 수   (page_per_record_cnt) : <%=page_per_record_cnt %><br />
한 페이지 당 보여줄 페이지 번호 수   (group_per_page_cnt) : <%=group_per_page_cnt %><br />
